...
echo '<a href="https://www.svnlabs.com/html5/faq/" target="_blank">frequently asked questions</a>';
echo '</div>';
...
echo '<a href="https://www.svnlabs.com/html5plus/shop/html5-mp3-player-for-wordpress/" target="_blank">[Buy Now HTML5 MP3 Player]</a><br />';

echo '</div>';

echo '<div>';
echo '<a href="https://www.svnlabs.com/html5/contact-us/" target="_blank">Contact US</a>';
echo '</div>';
